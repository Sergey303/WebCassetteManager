...
namespace WebCassetteManager
{
    public class CassettesHub : Hub
    {
        ...
        public void GetDirectValue(string subj, string predicate)
        {
            ...
            {
                Clients.Caller.updateArrayProperty(subj, predicate, objectVariant.ToString(), objectVariant.Variant==ObjectVariantEnum.Iri);
            }
        }
        public void GetInverseValue(string obj, string predicate)
        {
            ...
            {
                Clients.Caller.updateArrayProperty(subjVariant.ToString(), predicate, obj, true);
            }
        }
        ...
        public void GetItem( string id)
        {
            CasssettesBD.CasssettesBd.Store.Describe(id, (subj, pred, obj, isIri) =>
            {
                var @object = pred == "uri"
                    ...
                    : obj.ToString();
                Clients.Caller.updateArrayProperty(subj, pred, @object, isIri);
            });
